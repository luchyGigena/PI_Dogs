...
import Adapter from '@wojtekmaj/enzyme-adapter-react-17'//https://www.npmjs.com/package/@wojtekmaj/enzyme-adapter-react-17
...
describe('<CreateDog />', () => {
    ...
    describe('Estructura', () => {
        ...
        beforeEach(() => {
            ...
            wrapper = mount(<Provider> <CreateDog /> </Provider>);
        })
